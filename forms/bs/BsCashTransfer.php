...
class BsCashTransfer extends BaseModel{
    /**
     * 用户提现转账
     * @param Cash $cash
     * @return array
     */
    public static function transfer(Cash $cash,$title='用户提现'){
        if($cash->status == 1){
            ...
            $transferData = new BsTransferData([
                ...
                'notifyUrl' => \Yii::$app->getRequest()->getHostInfo() . "/web/withdraw-notify/bs.php",
            ]);
