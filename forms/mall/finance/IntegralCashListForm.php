...
use app\forms\mall\export\IntegralCashExport;
use app\helpers\SerializeHelper;
use app\models\BaseModel;
use app\models\IntegralCash;
use app\models\User;

class IntegralCashListForm extends BaseModel
{
    public $page;
    public $limit;
    public $status;
    ...
    public function search()
    {
        ...
        $query = IntegralCash::find()->alias('c')
        ...
        return $this->returnApiResultData(ApiCode::CODE_SUCCESS, '', [
            'list' => $newList,
            'export_list' => (new IntegralCashExport())->fieldsList(),
            'Statistics' => [
