		...
		<view v-if="list && list.length>0" class="shopping-main">
			<view v-for="item in list" class="shopping-coupon-group">
				...
				<view class="coupon-item-right">
					...
					<view class="item-plan">每{{item.integral_setting.period_unit=='month'?'月':'周'}}赠送{{item.integral_setting.integral_num}}{{currencyAlias.integral_alias}}分，赠送{{item.integral_setting.period}}{{item.integral_setting.period_unit=='month'?'个月':'周'}}</view>
