	...
	<view class="container">
		...
		<view class="foucs_H5"
			...
			<view class="foucs_H5_messga" style="float: left;">
				<text style="display: block;font-size: 25rpx;color: #fff;margin-top: 8rpx;">欢迎访问兰亭</text>
		...
		<view class="tui-pro-detail" v-if="goodsData">
			<view class="tui-product-title">
				...
				<view  style="width: 100%;height: 50rpx;line-height: 50rpx;padding: 0 30rpx;font-size: 30rpx;color: red;">
					需使用<text style="margin: 0 10rpx;">{{goodsData.shopping_voucher.voucher_price}}</text>{{currencyAlias.silver_beans_alias}}
				</view>
		...
		<view class="tui-operation">
			...
			<view class="tui-operation-right tui-right-flex tui-col-7 tui-btnbox-4">
				<view class="jx-btn" style="height: 80%;background:#FF7104;border-radius: 100rpx;"
					@click="showPopup(2)">
					用{{currencyAlias.silver_beans_alias}}下单
				</view>
			</view>
		</view>
